...
var (
	insertChainTimer = metrics.NewRegisteredTimer("core/state_process/insert_chain", nil)
	insertChainMeter = metrics.NewRegisteredMeter("core/state_process/insert_chain_count", nil)
)
...
func printMetrics() {
	...
	fmt.Println("	chain/execution_with_read.Percentile(0.5): ", blockExecutionWithReadTimer.Percentile(0.5))
	fmt.Println("	chain/execution_with_read.Percentile(0.75): ", blockExecutionWithReadTimer.Percentile(0.75))
	...
	fmt.Println("	chain/account/reads.Percentile(0.5): ", accountReadTimer.Percentile(0.5))
	fmt.Println("	chain/account/reads.Percentile(0.75): ", accountReadTimer.Percentile(0.75))
	fmt.Println("	chain/storage/reads.Mean: ", storageReadTimer.Mean())
	fmt.Println("	chain/storage/reads.Percentile(0.5): ", storageReadTimer.Percentile(0.5))
	fmt.Println("	chain/storage/reads.Percentile(0.75): ", storageReadTimer.Percentile(0.75))
